          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <li class="nav-item active">
                <a class="nav-link" href="index.php?opcao=4">Home</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="index1.php?opcao=1">História</a>
                  <a class="dropdown-item" href="index2.php?opcao=2">Cores e símbolos</a>
                  <a class="dropdown-item" href="index3.php?opcao=3">Estrutura e patrimônios</a>
                </div>
              </li>
            </ul>
          </div>
